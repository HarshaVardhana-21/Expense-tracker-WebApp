...
// forwardRef is required on React 18: Radix `asChild` triggers (DropdownMenuTrigger, DialogClose)
// attach a ref to their child to anchor popovers and restore focus.
